...
export const ruDictionary: Dictionary = {
    ...
    timedMode: {
        ...
        leaderboardHint:
            'Недельный рейтинг считает игры за последние 7 дней. При равных очках выше скорость.',
    ...
    quiz: {
        ...
        classicLeaderboardHint:
            'Недельный рейтинг считает игры за последние 7 дней.',
        ...
        mixed: 'Смешанная',
        mixedSplitMeta3:
            'Смесь: 1 легко + 1 средне + 1 сложно · очки 1 / 2 / 3',
        mixedSplitMeta5:
            'Смесь: 2 легко + 2 средне + 1 сложно · очки 1 / 2 / 3',
        mixedSplitMeta10:
            'Смесь: 4 легко + 3 средне + 3 сложно · очки 1 / 2 / 3',
    ...
    leaderboard: {
        title: 'Рейтинг',
        description:
            'Классика, блиц и челлендж дня — отдельные таблицы. В классике на 10 сложных вопросов максимум — 30 очков. Живой рейтинг считает игры за последние 7 дней; рекорды — вкладка «Всё время». Очки: легко 1, средне 2, сложно 3.',
        weekWindowHint:
            'В недельном рейтинге учитываются только игры за последние 7 дней. Чтобы сохранить место — сыграй снова. Рекорд за всё время — вкладка «Всё время».',
        allTimeHint:
            'Здесь рекорды без ограничения по дате. Живая гонка — вкладка «Неделя».',
        blitzSpeedHint: 'При равных очках выше тот, кто закончил быстрее.',
        rank: 'Место',
        player: 'Игрок',
        score: 'Очки',
        accuracy: 'Точность',
        date: 'Дата',
        empty: 'За последние 7 дней пока нет результатов. Сыграй первым.',
        emptyFiltered:
            'Пока нет результатов для выбранных фильтров. Смени режим, период или сложность — либо сыграй квиз.',
        loadFailed:
            'Не удалось загрузить рейтинг. Проверь подключение к базе данных и попробуй обновить страницу.',
        filterModeLabel: 'Режим',
