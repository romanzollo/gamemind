...
const questions = [
    {
        ...
        translations: {
            ru: { text: 'Какая компания создала серию Super Mario?' },
            en: { text: 'Which company created the Super Mario series?' },
        },
        options: [
            {
                order: 1,
            ...
            },
            {
                order: 2,
                isCorrect: false,
                translations: { ru: { text: 'Sega' }, en: { text: 'Sega' } },
            },
            {
                order: 3,
                isCorrect: false,
                translations: { ru: { text: 'Sony' }, en: { text: 'Sony' } },
            },
            {
                order: 4,
                isCorrect: false,
    ...
    },
    {
        ...
        translations: {
            ru: { text: 'Как зовут главного героя серии The Legend of Zelda?' },
            en: {
        ...
        options: [
            {
                order: 1,
                isCorrect: true,
                translations: { ru: { text: 'Link' }, en: { text: 'Link' } },
            },
            {
                order: 2,
                isCorrect: false,
                translations: { ru: { text: 'Zelda' }, en: { text: 'Zelda' } },
            },
            {
                order: 3,
                isCorrect: false,
            ...
            },
            {
                order: 4,
                isCorrect: false,
                translations: { ru: { text: 'Epona' }, en: { text: 'Epona' } },
            },
        ],
    },
    {
        ...
        translations: {
            ru: {
                text: 'Какой материал нужен для создания рамки портала в Нижний мир в Minecraft?',
            },
            en: {
    ...
    },
    {
        ...
        translations: {
            ru: { text: 'Какая студия разработала The Witcher 3: Wild Hunt?' },
            en: { text: 'Which studio developed The Witcher 3: Wild Hunt?' },
        },
        options: [
            {
                order: 1,
                isCorrect: true,
                translations: {
                    ru: { text: 'CD Projekt Red' },
                    en: { text: 'CD Projekt Red' },
                },
            },
            {
                order: 2,
            ...
            },
            {
                ...
                isCorrect: false,
                translations: {
                    ru: { text: 'Bethesda Game Studios' },
                    en: { text: 'Bethesda Game Studios' },
                },
            },
            {
                order: 4,
                isCorrect: false,
                translations: {
                    ru: { text: 'Larian Studios' },
                    en: { text: 'Larian Studios' },
                },
            },
        ],
    },
    {
        ...
        translations: {
            ru: {
                text: 'Как называется город, где происходит большая часть действий Cyberpunk 2077?',
            },
            en: {
    ...
    },
    {
        ...
        translations: {
            ru: {
                text: 'Какая игра популяризовала термин «roguelike», дав название жанру?',
            },
            en: {
        ...
        options: [
            {
                order: 1,
                isCorrect: true,
                translations: { ru: { text: 'Rogue' }, en: { text: 'Rogue' } },
            },
            {
                order: 2,
                isCorrect: false,
